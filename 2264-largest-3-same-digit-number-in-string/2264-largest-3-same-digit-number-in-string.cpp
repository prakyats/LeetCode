class Solution {
    vector<string> sameDigitNumbers = {"999", "888", "777", "666", "555",
                                       "444", "333", "222", "111", "000"};

    // Check whether the 'num' string contains the 'sameDigitNumber' string or
    // not.
...
public:
    string largestGoodInteger(string num) {
        // Iterate on all 'sameDigitNumbers' and check if the string 'num'
        // contains it.
